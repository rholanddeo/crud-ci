...
<div class="container container-fluid mt-5">
    ...
    <div class="card">
        ...
        "wrap": true
                        ...
                        <input type="text" name="tglbeli" class="flatpickr-custom-form-control form-control" id="projectDeadlineFlatpickrNewProjectLabel" placeholder="Select dates" data-input value="">
