...
<div class="container container-fluid mt-5 ">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-auto">
        <a class="btn btn-primary" href="<?php echo base_url('suplier-create') ?>">
          <i class="bi-plus-lg me-1"></i> Tambah Suplier
        </a>
      </div>
      <!-- End Col -->
    </div>
  ...
  <?php if (!empty(session()->getFlashdata('message'))) : ?>
    <!-- Toast -->
    <div id="toast" class="toast align-items-center text-bg-soft-success border-0 show" role="alert" aria-live="assertive" aria-atomic="true" style="position:fixed; top: 20px; right: 20px; z-index: 1000;">
      <div class="d-flex">
