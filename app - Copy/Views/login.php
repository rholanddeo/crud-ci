    ...
    <div class="container py-5 py-sm-7">
      ...
      <div class="mx-auto" style="max-width: 30rem;">
        ...
        <div class="card card-lg mb-5">
          <div class="card-body">
            <!-- Form -->
            <form class="js-validate needs-validation" action="<?php echo base_url('barang') ?>" method="GET" novalidate>
              <div class="text-center">
                <div class="mb-5">
                  <h1 class="display-5">Sign in</h1>
                  <p>Don't have an account yet? <a class="link" href="javascript:;">Sign up here</a></p>
                </div>
